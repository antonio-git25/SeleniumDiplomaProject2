...
class Traumatic_page(Base):
    ...
    calibr_down = "//button[@id=':r1:']"
    calibr_input = "//input[@id='kalibr_2-filter']"
    calibr_chbox = "//label[contains(text(),'10x28')]"
    shotgun = "//button[@title='Купить Пистолет ООП Grand Power T12-FM2 (азотированный) калибр 10х28']"
    ...
    def click_shotgun(self):
        ...
        print("Choose shotgun: Пистолет ООП Grand Power T12-FM2 (азотированный) калибр 10х28")
        time.sleep(10)
    ...
    def check_current_location(self):
        ...
        time.sleep(3)
        url_2 = "https://ohotaktiv.ru/catalog/travmaticheskoe-oruzhie/"
        get_url2 = self.driver.current_url
        assert url_2 == get_url2
        print(get_url2)
        value_header = self.get_title_2().text
        assert value_header == "Травматическое оружие"
        print(value_header)
    ...
    def choose_product(self):
        ...
        self.click_shotgun()
        time.sleep(12)
        self.get_screenshot("traumatic-gun", "catalog")
